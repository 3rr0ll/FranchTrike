  ...
  <section class="min-h-screen flex items-center justify-center bg-gray-100"
    ...
    <div class="w-full min-h-screen flex items-center justify-center px-2 sm:px-6">
      <div class="w-full max-w-5xl mx-auto flex flex-col lg:flex-row items-stretch bg-transparent my-8 sm:my-12">
        <!-- Login Form Side -->
        <div
          class="w-full lg:w-1/2 flex flex-col justify-center bg-white rounded-l-xl lg:rounded-r-none rounded-xl shadow-2xl border border-gray-200 px-8 py-10">
          <div class="mb-4">
            <a href="{{ url('/') }}"
              class="inline-flex items-center text-primary-navy hover:text-accent-purple font-medium text-sm transition-colors">
          ...
          <h2 class="text-xl font-bold text-primary-navy mb-2 text-center">Sign in to your account</h2>
          ...
          <form class="space-y-5" method="POST" action="{{ route('login') }}">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <button type="button" id="togglePassword"
                  class="absolute inset-y-0 right-0 flex items-center pr-3 text-primary-navy focus:outline-none"
                  tabindex="-1">
            ...
            <div class="flex items-center justify-between">
              ...
              @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}"
                  class="text-sm font-medium text-primary-navy hover:underline">Forgot password?</a>
              @endif
            </div>
            ...
            <button type="submit"
              ...
              <a href="http://localhost/Franchise/franchtrike/public/auth/google"
            ...
            <div class="flex justify-center">
              <div class="text-sm text-gray-500 text-center">
                ...
                <a href="{{ route('register') }}" class="font-medium text-primary-navy hover:underline">Sign up now</a>
              </div>
            </div>
          </form>
        </div>
        ...
        <div
          class="hidden lg:flex w-1/2 bg-gradient-to-br from-primary-navy to-accent-purple items-center justify-center rounded-r-xl">
