...
<div class="w-full mx-auto py-8 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow-lg rounded-lg px-6 py-8">
        <form action="{{ route('admin.operators.update', $operator->operator_id ?? $operator->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input value="{{ old('civil_status', $operator->civil_status) }}" type="text"
