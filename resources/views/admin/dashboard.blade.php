...
@section('content')
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-4 flex flex-col">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="{{ route('admin.franchise.index') }}" class="text-blue-600 hover:text-blue-800"
            ...
            <div class="bg-white rounded-lg shadow p-4 flex flex-col">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="{{ route('admin.operators.index') }}" class="ml-4 text-green-600 hover:text-green-800"
            ...
            <div class="bg-white rounded-lg shadow p-4 flex flex-col">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="{{ route('admin.drivers.index') }}" class="ml-4 text-purple-600 hover:text-purple-800"
                        title="View Drivers">
                        <x-button>
                            View
                        </x-button>
        ...
        <div class="bg-white rounded-lg shadow p-6 flex flex-col items-center justify-center">
            <span class="text-gray-600 text-md mb-2">Franchise Applications Pending Review</span>
            <span class="text-4xl font-bold text-blue-600">{{ $pendingReview ?? 0 }}</span>
            <a href="{{ route('admin.franchise.index', ['status' => ['under_review']]) }}"
                class="mt-4 text-blue-600 hover:text-blue-800" title="View Pending Review Franchise Applications">
                <x-button>
                    View
                </x-button>
            </a>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="text-sm font-medium text-gray-900">{{ $todayStats['applications_reviewed'] ?? 0 }}</span>
                    </div>
                    <div class="flex justify-between">
