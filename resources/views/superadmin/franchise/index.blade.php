...
@section('content')
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['submitted'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['under_review'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['approved'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Renewed</dt>
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['renewed'] ?? 0 }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['rejected'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $statusCounts['expired'] ?? 0 }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="p-4 border-b border-gray-200 lg:mt-1.5">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <!-- Responsive: Filters + Date Range Picker + Export Buttons -->
            <div class="w-full">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 w-full">

                    <!-- Filters (Type + Status) as Grid on small, Row on md+ -->
                    ...
                    <!-- Date Range Picker & Export on next row for small screens -->
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4 w-full md:w-auto mt-2 md:mt-0">
                        <!-- Date Range Picker -->
                        <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                            <span class="text-gray-600 whitespace-nowrap">From:</span>
                            <input type="date" id="datepicker-range-start"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 flex-1 min-w-[120px]">
                            <span class="text-gray-600 whitespace-nowrap">to</span>
                            <input type="date" id="datepicker-range-end"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 flex-1 min-w-[120px]">
                        </div>
                        <!-- Export Buttons -->
                        <div id="export-buttons" class="flex flex-wrap gap-2 items-center w-full sm:w-auto mt-2 sm:mt-0">
