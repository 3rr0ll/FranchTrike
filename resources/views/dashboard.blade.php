...
<body class="bg-white text-primary-navy font-['Inter']">
    ...
    <button id="chatbot-toggle" class="fixed bottom-6 right-6 bg-primary-gold text-primary-navy p-4 rounded-full shadow-xl hover:bg-yellow-400 transition-all z-50 group">
        <i class="bi bi-chat-dots-fill text-2xl group-hover:scale-110 transition-transform"></i>
    </button>

    <!-- Chatbot Popup -->
    <div id="chatbot-box" class="fixed bottom-24 right-6 w-96 bg-white rounded-2xl shadow-2xl hidden flex-col z-50">
        ...
        <div class="p-4 h-96 overflow-y-auto text-sm space-y-4" id="chatbot-messages">
    ...
    <script>
        ...
        chatbotForm.addEventListener('submit', (e) => {
            ...
            if (userMsg) {
                ...
                userDiv.innerHTML = `
          <div class="bg-primary-navy text-white rounded-2xl rounded-tr-none p-3 max-w-[80%]">
            ${userMsg}
          </div>
        ...
        `;
            ...
            <div class="bg-gray-100 rounded-2xl rounded-tl-none p-3 max-w-[80%]">
              🤖 I'm a demo bot. Real chat support coming soon!
            </div>
          `;
