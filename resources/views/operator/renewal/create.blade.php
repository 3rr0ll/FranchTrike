...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-7xl mx-auto">
        ...
        <form action="{{ route('operator.renewal.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            
            <div class="mb-10 bg-gray-50 rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 bg-white">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file-operator-{{ $docType->document_id }}"
                                class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 relative bg-gray-50"
            ...
            <div class="mb-5 mt-5 bg-gray-50 rounded-lg border border-gray-200 p-6">
                <h3 class="text-2xl font-semibold text-primary-navy mb-4">Driver Documents</h3>
                @php
                    // Only show the driver(s) under the franchise being renewed
                    $selectedDrivers = isset($franchiseDrivers) ? $franchiseDrivers : (isset($driver) ? [$driver] : []);
                @endphp
