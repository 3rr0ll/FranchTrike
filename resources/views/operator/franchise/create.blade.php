...
<div class="max-w-4xl mx-auto mt-6 bg-white p-6 rounded-lg shadow">
    ...
    <x-button type="button" onclick="window.history.back();" class="inline-flex items-center mb-3 px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        Back
    </x-button>
