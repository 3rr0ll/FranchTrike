    ...
    public function approve(MotorChangeRequest $motorChange)
    {
        try {
            ...
            \App\Helpers\ActivityLogger::log(
                ...
                [
                    'motor change request id' => $motorChange->id,
                    'motor detail id' => $motorDetail->id,
                    'franchise application_id' => $franchiseApplication->id,
                    'old unit type' => $motorChange->old_unit_type,
                    'old unit make id' => $motorChange->old_unit_make_id,
                    'old motorno' => $motorChange->old_motorno,
                    'old chasisno' => $motorChange->old_chasisno,
                    'old platenumber' => $motorChange->old_platenumber,
                    'new unit type' => $motorChange->new_unit_type,
                    'new unit make id' => $motorChange->new_unit_make_id,
                    'new motorno' => $motorChange->new_motorno,
                    'new chasisno' => $motorChange->new_chasisno,
                    'new platenumber' => $motorChange->new_platenumber,
                    'reviewed by' => Auth::user()->name,
                ]
            );
